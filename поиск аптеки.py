...
map_params = {
    ...
    "pt": f"{org_point},pma~{toponym_coodrinates},pma"
}
...
distanse = lonlat_distance([float(x) for x in org_point.split(',')], [float(x) for x in toponym_coodrinates.split(',')])
